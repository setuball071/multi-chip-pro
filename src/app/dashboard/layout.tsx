...
import { Bot, History, LayoutDashboard, LogOut, MessageSquare, Send, User, Users } from "lucide-react";
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="justify-start gap-2 w-full p-2 h-auto group-data-[collapsible=icon]:w-auto group-data-[collapsible=icon]:justify-center">
                 <Avatar className="h-8 w-8">
                  <AvatarImage src="https://placehold.co/100x100" alt="Agente de Vendas" data-ai-hint="profile avatar" />
      ...
      <SidebarInset>
        <header className="flex h-14 items-center gap-4 border-b bg-card px-4 lg:h-[60px] lg:px-6 sticky top-0 z-30">
            ...
            <h1 className="text-lg font-semibold md:text-2xl font-headline">
              {menuItems.find(item => pathname.startsWith(item.href))?.label || 'Painel'}
            </h1>
        </header>
