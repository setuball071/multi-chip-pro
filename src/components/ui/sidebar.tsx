  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Isso é o que lida com o espaço da barra lateral na área de trabalho */}
        <div
          className={cn(
        ...
        <div
          className={cn(
            ...
            // Ajusta o preenchimento para as variantes flutuante e embutida.
            variant === "floating" || variant === "inset"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Aumenta a área de acerto do botão no celular.
